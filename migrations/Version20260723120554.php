 ...
 */
final class Version20260723120554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE volunteering ADD COLUMN skills CLOB NOT NULL');
        $this->addSql('ALTER TABLE volunteering ADD COLUMN experience_level VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE volunteering ADD COLUMN notes CLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO volunteering (
              id, conference_id, for_user_id, start_at,
              end_at
            )
            SELECT
              id,
